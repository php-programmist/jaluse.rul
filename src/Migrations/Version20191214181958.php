 ...
 */
final class Version20191214181958 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE page ADD category_id INT DEFAULT NULL, ADD popular TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE page DROP category_id, DROP popular');
    }
}
