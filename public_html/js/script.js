...
$('.minimages1').click(function(event) { $('.calc-vivod-imgwrap img').attr('src', 'img/calc-img/1.jpg');});
$('.minimages2').click(function(event) { $('.calc-vivod-imgwrap img').attr('src', 'img/calc-img/2.jpg');});
$('.minimages3').click(function(event) { $('.calc-vivod-imgwrap img').attr('src', 'img/calc-img/3.jpg');});
$('.minimages4').click(function(event) { $('.calc-vivod-imgwrap img').attr('src', 'img/calc-img/4.jpg');});
$('.minimages5').click(function(event) { $('.calc-vivod-imgwrap img').attr('src', 'img/calc-img/5.jpg');});
$('.minimages6').click(function(event) { $('.calc-vivod-imgwrap img').attr('src', 'img/calc-img/6.jpg');});
$('.minimages7').click(function(event) { $('.calc-vivod-imgwrap img').attr('src', 'img/calc-img/7.jpg');});
$('.minimages8').click(function(event) { $('.calc-vivod-imgwrap img').attr('src', 'img/calc-img/8.jpg');});
$('.minimages9').click(function(event) { $('.calc-vivod-imgwrap img').attr('src', 'img/calc-img/9.jpg');});
$('.minimages10').click(function(event) { $('.calc-vivod-imgwrap img').attr('src', 'img/calc-img/10.jpg');});
$('.minimages11').click(function(event) { $('.calc-vivod-imgwrap img').attr('src', 'img/calc-img/11.jpg');});
$('.minimages12').click(function(event) { $('.calc-vivod-imgwrap img').attr('src', 'img/calc-img/12.jpg');});
$('.minimages13').click(function(event) { $('.calc-vivod-imgwrap img').attr('src', 'img/calc-img/13.jpg');});
$('.minimages14').click(function(event) { $('.calc-vivod-imgwrap img').attr('src', 'img/calc-img/14.jpg');});
